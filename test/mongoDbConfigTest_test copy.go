...
func Test_GetMongoClient(t *testing.T) {
	...
	_, err = db.Collection(config.Configuration().Database.Mongodb.Collection).InsertOne(ctx, model.Article{
		Id:        "123123",
		Title:     "Test",
		CreatedAt: time.Now(),
		Content: `# Ahmad Mardiana: Experienced Java Developer with Networking Expertise
